        ...
        <div class="row middle-xs">
            ...
            <div class="col col-xs-6">
                <div class="form-group m-xs-b-4">
                    ...
                    <input v-model="ticket_quantity" class="form-control">
                </div>
            </div>
        </div>
...
<script>
  export default {
    ...
    computed: {
      description() {
        if (this.ticket_quantity > 1) {
          return `${this.ticket_quantity} tickets to ${this.concertTitle}`;
        }
        return `One ticket to ${this.concertTitle}`;
      },
      totalPrice() {
        return this.ticket_quantity * this.price;
      },
      priceInDollars() {
